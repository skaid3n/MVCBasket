    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="<?= URL ?>jugadores/ordenar/nombreEquipo">Nombre Equipo</a>
          <a class="dropdown-item" href="<?= URL ?>jugadores/ordenar/nacionalidad">Nacionalidad</a>
          <a class="dropdown-item" href="<?= URL ?>jugadores/ordenar/fechNac">Fecha Nacimiento</a>
